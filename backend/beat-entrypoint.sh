...
do
    ...
    if [ $RETRY_COUNT -ge $MAX_RETRIES ]; then
        ...
        echo "⚠️  Beat를 계속 시작하지만 작업 처리 시 오류가 발생할 수 있습니다"
        break
    fi
...
# Celery Beat 시작
echo "[4/4] Celery Beat 시작..."
echo "ℹ️  Beat 로그 레벨: ${LOG_LEVEL}"
echo "ℹ️  이제부터 Celery Beat 로그가 표시됩니다..."
echo ""
